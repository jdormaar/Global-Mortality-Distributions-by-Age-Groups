...
> This chart is simple, but quite visually appealing. (_Side note: When an individual cause of mortality is selected, this chart transforms into thin vertical slices colour coded by country. Which is fabulously reminiscent to the gravitational anomalies generated by the man in the spherical black-hole depicted in the film Interstellar...so, that's cool!!!_)
